    ...
    <header className='relative z-10 bg-white border-b-4 border-black shadow-[0px_8px_0px_0px_rgba(0,0,0,1)]'>
      <div className='container mx-auto px-6 py-4 flex items-center justify-between'>
        ...
        <nav className='hidden md:flex items-center gap-8 text-black font-bold'>
          <span className='hover:text-gray-700 transition-colors cursor-pointer'>Características</span>
          <span className='hover:text-gray-700 transition-colors cursor-pointer'>Cómo funciona</span>
          <span className='hover:text-gray-700 transition-colors cursor-pointer'>FAQ</span>
          <Button
            variant='secondary'
            size='sm'
